...
return [
  ...
  'custom' => [
    ...
    'last_name' => [
      ...
      'max' => ' The last name name may not be greater than :max characters',
    ],
    'user' => [
      'required' => ' The user is required',
      'min' => ' The user must be at least :min characters',
      'max' => ' The user must have as maximum :max characters'
    ],
    'email' => [
      'required' => ' The email is required',
      'email' => ' The email must have a valid format',
      'min' => ' The email must be at least :min characters',
      'max' => ' The email must have as maximum :max characters'
    ]
  ],
